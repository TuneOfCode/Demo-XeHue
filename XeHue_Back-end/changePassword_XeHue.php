    ...
    <div class="login">
        ...
        <div class="form">
            <form action="" method="POST">
                <div class="account">
                   <i class="fa fa-lock"></i><label class="lb" for="">Nhập mật khẩu cũ</label>
                   <input type="password" min="5" name="password" required>
                </div>
                <div class="password">
                    <i class="fa fa-lock"></i><label class="lb" for="">Nhập mật khẩu mới</label>
                    <input type="password" min="5" name="new_password" id="" required>
                    <i class="fa fa-lock"></i><label class="lb" for="">Nhập lại mật khẩu mới</label>
                    <input type="password" min="5" name="re_password" id="" required>
                </div>
